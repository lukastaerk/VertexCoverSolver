...
PROGRAMM_NAME="python3 solver/branch_and_bound.py"  		# insert your program here
...
maxSecPerInstance=20							# allowed time (in seconds) for one instance
maxNotSolved=50								# no of instances the program is allowed to fail to solve. If reached, then the script is aborted
