...
class TestReadGraph(unittest.TestCase):
    ...
    def test_read_graph_fast(self):
        ...
        # read input for file 
        open_file = open("../data/2-social-networks/88-auto.graph.dimacs", "r")
        ...
        self.assertEqual(len(adjacency_list), 448695)
        self.assertEqual(len(edges), 3314611)
        self.assertGreaterEqual(6.0, end_time - start_time)
